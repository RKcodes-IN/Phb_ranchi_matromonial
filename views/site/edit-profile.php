...
<style>
    form#login-form-inline input, form#login-form-inline select {
    /* width: 100%; */
    height: 31px;
    font-size: 14px;
}
label {
    ...
    <div class="card p-2">
        <div class="card-title">
            <h2 class="bg-primary p-1 rounded">Update Your Profile</h2>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <?= $form->field($user, 'username', ['enableAjaxValidation' => false])->textInput(['readonly'=> true]); ?>
    ...
    <div class="card p-2">
        <div class="card-title">
            <h2 class="bg-primary p-1 rounded">Update Your Details</h2>
        </div>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <?= $form->field($model, 'register_number')->textInput(['maxlength' => true, 'placeholder' => 'Registration Number','readonly'=> true]) ?>
    ...
    <div class="card p-2">
        <div class="card-title">
            <h2 class="bg-primary p-1 rounded">Family Details</h2>
        </div>
