...
/* @var $searchModel app\modules\admin\models\search\LoanSearch */
...
<?php 
    $gridColumn = [
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-loan-search-user_id']
            ],
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->loanType->name;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\app\modules\admin\models\LoanTypes::find()->asArray()->all(), 'id', 'name'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],
                'filterInputOptions' => ['placeholder' => 'Loan types', 'id' => 'grid-loan-search-loan_type']
            ],
        ...
        [
                ...
                'filterInputOptions' => ['placeholder' => 'User', 'id' => 'grid-loan-search-agent_id']
            ],
